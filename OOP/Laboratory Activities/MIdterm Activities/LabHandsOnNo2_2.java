...
Take note:
  When you run this java file, rename this "LabHandsOnNo2_2.java" into "LabHandsOnNo2.java".
...
class LabHandsOnNo2{
    ...
    public static void userInterface(Scanner scanner){
        ...
        System.out.println("Welcome to Laboratory Activity No.2.");
    ...
    public static void ageValidation(int userAge){
        ...
        if (userAge > ageCategory && userAge >= 18){
            System.out.println("Using conditional statement if and else:");
        ...
        switch(ageCategory){
            case 0 -> System.out.println("Using conditional statement switch statement: \n You are not eligible to vote");
            case 1, 2, 3, 4, 5, 6 -> System.out.println(" Using conditional statement switch statement: \n You are eligible to vote");
        }
            ...
            try {
                ...
                switch(grade){
                    case 'A':
                        ...
                        break;
                    case 'B':
                        System.out.println("Good job! Try to aim for an A.");
                        is_Valid = true;
                        break;
                    case 'C':
    ...
    public static void usingRepeatingLoops(Scanner scanner){
